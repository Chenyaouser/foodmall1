...
<head>
    ...
    <style>
        body{
              background-image: url("resources/image/zcbg.jpg");
          }
        #div1{
...
<form class="form-horizontal" action="/toReg"  method="post" >
    ...
    <label for="d1" class="col-sm-2 control-label">用&nbsp;户名：</label>
    <div class="col-sm-10">
        <input type="text" name="name" style="width: 100%" font class="form-control" id="d1" placeholder="请输入用户名...">
